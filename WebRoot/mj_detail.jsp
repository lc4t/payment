...
if(flag!=null){
	...
	for(PayInfoVO vo : list){
		if (vo.getPayState() == 1) {
			//num += vo.getPayPrice();
			if("2000000".equals(vo.getPayGameId()) || "3000000".equals(vo.getPayGameId())) {
				num1 += vo.getPayPrice();
			}
		}
	}
		  ...
		  <TD vAlign=top width=90%><TABLE cellSpacing=0 cellPadding=0 width=90% align=center border=0>
			  <TBODY>
				...
				<TR>
				  ...
				  <br/>
				  <form action="<%=basePath%>mj_detail.jsp" method="post">
				  ...
				  <table align="center" cellpadding="0" cellspacing="0" border="1" width="100%" height="18%" id="dataTable">
						<thead>
							<tr><td align="center" colspan="5" >魔界总金额</td><td align="center" colspan="2" ><%=num1%></td></tr>
							<tr>
								<td align="center" nowrap >payid</td>
								<td align="center" nowrap >游戏</td>
								<td align="center" nowrap >gameid</td>
						...
						<tbody>
								<% 
									for(PayInfoVO vo : list){
										if (vo.getPayState() == 1 && ("2000000".equals(vo.getPayGameId()) || "3000000".equals(vo.getPayGameId()))) {
								%>
								<tr>
									<td align="center" nowrap ><a href="webOrderDetail.jsp?orderid=<%=vo.getGamePayid()%>"><%=vo.getGamePayid()%></a></td>
									<td align="center" nowrap >魔界</td>
									<td align="center" nowrap ><%=vo.getPayGameId()%></td>
									<td align="center" nowrap ><%=vo.getPayRoleId() %></td>
