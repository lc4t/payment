...
if(flag!=null){
	...
	for(PayInfoVO vo : list){
		if (vo.getPayState() == 1) {
			//num += vo.getPayPrice();
			if("4400000".equals(vo.getPayGameId())) {
				num1 += vo.getPayPrice();
			}
		}
	}
		  ...
		  <TD vAlign=top width=90%><TABLE cellSpacing=0 cellPadding=0 width=90% align=center border=0>
			  <TBODY>
				...
				<TR>
				  ...
				  <br/>
				  <form action="<%=basePath%>sg_detail.jsp" method="post">
				  ...
				  <table align="center" cellpadding="0" cellspacing="0" border="1" width="100%" height="18%" id="dataTable">
						<thead>
							<tr><td align="center" colspan="5" >口袋三国总金额</td><td align="center" colspan="2" ><%=num1%></td></tr>
							<tr>
