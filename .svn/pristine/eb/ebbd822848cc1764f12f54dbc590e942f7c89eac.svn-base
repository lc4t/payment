package noumena.payment.dao.servlet.c07073;
...
public class C07073Servlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_07073);
			vo.setCallbackUrl(cburl);
			
			ret = C07073Charge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = C07073Charge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("07073 model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("07073 order id->(" + uid + ")" + ret);
