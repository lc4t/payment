...
public class App01Servlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_APP01);
			vo.setCallbackUrl(cburl);
			
			ret = App01Charge.getTransactionId(vo);
		}
		else
		{
			ret = App01Charge.checkOrdersStatus(payIds);
		}

		System.out.println("app01 order id->" + ret);
