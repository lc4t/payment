...
public class MobojoyServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_MOBOJOY);
			vo.setCallbackUrl(cburl);
			
			ret = MobojoyCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = MobojoyCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("mobojoy model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("mobojoy order id->(" + uid + ")" + ret);
