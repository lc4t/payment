package noumena.payment.dao.servlet.oppo;
...
import noumena.payment.oppo.OppoCharge;
...
public class OppoServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_OPPO);
			vo.setCallbackUrl(cburl);
			
			ret = OppoCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = OppoCharge.checkOrdersStatus(payIds);
		}
		else
		{
