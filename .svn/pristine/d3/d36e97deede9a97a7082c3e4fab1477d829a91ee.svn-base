...
public class GoogleOrderVO
{
	...
	/** default constructor */
	public GoogleOrderVO() {
	}

	/** minimal constructor */
	public GoogleOrderVO(Integer status) {
		this.status = status;
	}

	/** full constructor */
	public GoogleOrderVO(String txnId, Integer userId, String app, String callbackUrl, String logTime, String paymentDate, Float mcGross, String itemId, Integer quantity, String mcCurrency,
	...
	public GoogleOrderVO(int purchaseState,String notifyId,String productId,String orderId, String purchaseTime, String developerPayload){
		...
		this.business = GoogleParams.GOOGLEPLAY;
