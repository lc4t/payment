package noumena.payment.dao.servlet.liebao;
...
public class LiebaoServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_LIEBAO);
			vo.setCallbackUrl(cburl);
			vo.setExInfo(appid);
			
			ret = LiebaoCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = LiebaoCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(liebao model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(liebao order id)->(" + uid + ")" + ret);
