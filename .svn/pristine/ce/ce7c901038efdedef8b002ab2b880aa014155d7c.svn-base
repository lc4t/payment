package noumena.payment.dao.servlet.c3ggate;
...
public class C3GGateServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setSign(appid + "_" + cpid);
			vo.setPayType(Constants.PAY_TYPE_3GGATE);
			vo.setCallbackUrl(cburl);
			
			ret = C3GGateCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = C3GGateCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("3ggate model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("3ggtate order id->(" + uid + ")" + ret);
