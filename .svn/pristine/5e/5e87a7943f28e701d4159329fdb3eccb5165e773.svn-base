...
public class YouxinServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_YOUXIN);
			vo.setCallbackUrl(cburl);
			
			ret = YouxinCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = YouxinCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("youxin model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("youxin order id->(" + uid + ")" + ret);
