...
public class JusdkServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_JUSDK);
			vo.setCallbackUrl(cburl);
			
			ret = JusdkCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = JusdkCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("jusdk model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("jusdk order id->(" + uid + ")" + ret);
