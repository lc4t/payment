package noumena.payment.dao.servlet.igame;
...
public class IGameServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_IGAME);
			vo.setCallbackUrl(cburl);
			vo.setExInfo(appid);
			
			ret = IGameCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = IGameCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(igame model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(igame order id)->(" + uid + ")" + ret);
