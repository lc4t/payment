package noumena.payment.dao.servlet.duoku;
...
public class DuokuServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_DUOKU);
			vo.setCallbackUrl(cburl);
			
			ret = DuokuCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = DuokuCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("duoku model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("duoku order id->(" + uid + ")" + ret);
