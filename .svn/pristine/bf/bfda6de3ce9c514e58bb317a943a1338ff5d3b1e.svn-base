package noumena.payment.dao.servlet.igs;
...
public class IGSServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String Environment = request.getParameter("Environment");	//0-开发，1-测试，2-正式
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_IGS);
			vo.setCallbackUrl(cburl);
			
			ret = IGSCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
//			ret = IGSCharge.checkOrdersStatus(payIds);
		}
		else if (stype.equals("3"))
		{
			...
			ret = IGSCharge.getTransactionIdAndStatus(vo, AccountID, GameID, AppID, UserID, UserName, GroupNo, ServerNo, Environment);
		}
		else
		{
			System.out.println("igs model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("igs order id->(" + uid + ")" + ret);
