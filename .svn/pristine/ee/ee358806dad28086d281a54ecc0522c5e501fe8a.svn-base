package noumena.payment.dao.servlet.lengjing;
...
public class LengjingServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		//支付方的参数
		String channelLabel = request.getParameter("channelLabel");
		...
		if (stype.equals("1"))
		{
			String paytype = "lj_"+channelLabel;
			...
			vo.setSign(appid);
			vo.setExInfo(Constants.PAY_TYPE_LENGJING);
			
			
			ret = LengjingCharge.getTransactionId(vo,paytype);
		}
		else if (stype.equals("2"))
		{
			ret = LengjingCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(lengjing model invalid)->stype(" + stype+")");
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(lengjing order id)->(" + uid + ")" + ret);
