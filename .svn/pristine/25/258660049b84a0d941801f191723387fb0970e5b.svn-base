package noumena.payment.dao.servlet.game65;
...
public class Game65Servlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_GAME65);
			vo.setCallbackUrl(cburl);
			
			ret = Game65Charge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = Game65Charge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("Game65 model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("Game65 order id->(" + uid + ")" + ret);
