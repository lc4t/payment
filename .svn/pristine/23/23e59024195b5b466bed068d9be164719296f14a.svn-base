package noumena.payment.dao.servlet.qidian;
...
public class QidianServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String itemprice = request.getParameter("itemprice");	//充值获得的钻数
		...
		if (stype.equals("1"))
		{
			...
			ret = QidianCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = QidianCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("qidian model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("qidian order id->(" + uid + ")" + ret);
