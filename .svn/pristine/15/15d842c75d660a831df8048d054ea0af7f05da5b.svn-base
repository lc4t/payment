package noumena.payment.dao.servlet.c49you;
...
public class C49youServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_SIJIUYOU);
			vo.setCallbackUrl(cburl);
			
			ret = C49youCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = C49youCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("49you model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("49you order id->(" + uid + ")" + ret);
