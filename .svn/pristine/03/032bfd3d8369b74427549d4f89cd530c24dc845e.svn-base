...
public class CCTCServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		{
			payTypeId = Constants.PAY_TYPE_TELCOM;
		}
		...
		if (stype.equals("1"))
		{
			System.out.println("cctc app id->" + vo.getAppId());
			System.out.println("cctc product id->" + vo.getProductId());
			System.out.println("cctc sub id->" + vo.getSubId());
			
			ret = CCTCCharge.getTransactionId(vo);
		}
		else
		{
			System.out.println("cctc check order ids->" + payIds);
			ret = CCTCCharge.checkOrdersStatus(payIds);
		}

		System.out.println("cctc order id->" + ret);
