package noumena.payment.dao.servlet.gmobi;
...
public class GmobiServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_GMOBI);
			vo.setCallbackUrl(cburl);
			
			ret = GmobiCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = GmobiCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("gmobi model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("gmobi order id->(" + uid + ")" + ret);
