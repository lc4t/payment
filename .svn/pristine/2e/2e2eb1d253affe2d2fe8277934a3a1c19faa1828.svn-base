package noumena.payment.dao.servlet.nduo;
...
public class NduoServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_NDUO);
			vo.setCallbackUrl(cburl);
			
			ret = NduoCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = NduoCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(nduo model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(nduo order id)->(" + uid + ")" + ret);
