package noumena.payment.dao.servlet.qiangwan;
...
public class QiangWanServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (stype.equals("1")) {
			...
			vo.setPayType(Constants.PAY_TYPE_QIDIAN);
			vo.setCallbackUrl(cburl);
			vo.setSign(appid);
			System.out.println("qiangwan Orders param==============================>" + vo);
			ret = OrderUtil.getTransactionId(vo, "", "");
		} else if (stype.equals("2")) {
			OrderStatusVO st = new OrderStatusVO();
			ret = OrderUtil.checkOrdersStatus(payIds, st);
		} else {
			System.out.println("qiangwan model invalid-==============================>" + stype);
			ret = "invalid";
		}

		System.out.println("qiangwan order id-====================================>(" + uid + ")" + ret);
