...
public class SuoleServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		{
			payTypeId = Constants.PAY_TYPE_SUOLE;
		}
		...
		if (stype.equals("1"))
		{
			...
			ret = SuoleCharge.getTransactionId(vo);
		}
		else
		{
			System.out.println("check order ids->" + payIds);
			ret = SuoleCharge.checkOrdersStatus(payIds);
		}
