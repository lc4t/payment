package noumena.payment.dao.servlet.efun;
...
public class EfunServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			ret = EfunCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = EfunCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(efun model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(efun order id)->(" + uid + ")" + ret);
