package noumena.payment.dao.servlet.meizu;
...
public class MeizuServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			ret = MeizuCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = MeizuCharge.checkOrdersStatus(payIds);
		}
		else
		{
