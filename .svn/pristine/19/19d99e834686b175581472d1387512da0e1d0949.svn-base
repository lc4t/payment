package noumena.payment.dao.servlet.duowan;
...
public class DuowanServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_DUOWAN);
			vo.setCallbackUrl(cburl);
			
			ret = DuowanCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = DuowanCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("duowan model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("duowan order id->(" + uid + ")" + ret);
