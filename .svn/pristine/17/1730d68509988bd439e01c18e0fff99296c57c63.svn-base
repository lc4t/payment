package noumena.payment.dao.servlet.xingshang;
...
public class XingshangServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_XINGSHANG);
			vo.setCallbackUrl(cburl);
			vo.setExInfo(appid);
			
			ret = XingshangCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = XingshangCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(xingshang model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(xingshang order id)->(" + uid + ")" + ret);
