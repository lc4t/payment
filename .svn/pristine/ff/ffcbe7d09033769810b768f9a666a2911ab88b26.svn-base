...
function loadcalendar() {
	...
	s += "<tr align=\"center\" class=\"header\"><td class=\"header\"><a href=\"#\" onclick=\"refreshcalendar(yy, mm-1);return false\" ><<</a></td><td colspan=\"5\" style=\"text-align: center\" class=\"header\"><a href=\"#\" onclick=\"showdiv('year');_cancelBubble(event);return false\"  id=\"year\"></a>  -  <a id=\"month\"  href=\"#\" onclick=\"showdiv('month');_cancelBubble(event);return false\"></a></td><td class=\"header\"><A href=\"#\" onclick=\"refreshcalendar(yy, mm+1);return false\">>></A></td></tr>";
	...
	s += "<tr id=\"hourminute\"><td colspan=\"7\" align=\"center\"><input type=\"text\" size=\"1\" value=\"\" id=\"hour\" onKeyUp='this.value=this.value > 23 ? 23 : zerofill(this.value);controlid.value=controlid.value.replace(/\\d+(:\\d+)/ig, this.value+\"$1\")'> \xb5\xe3 <input type=\"text\" size=\"1\" value=\"\" id=\"minute\" onKeyUp='this.value=this.value > 59 ? 59 : zerofill(this.value);controlid.value=controlid.value.replace(/(\\d+:)\\d+/ig, \"$1\"+this.value)'> \xb7\xd6</td></tr>";
	s += "</table></div></div>";
