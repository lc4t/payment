package noumena.payment.dao.servlet.card19;
...
import noumena.payment.card19.Card19Charge;
import noumena.payment.model.Orders;
import noumena.payment.util.Constants;
import noumena.payment.util.DateUtil;

public class Card19Servlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_CARD19);
			vo.setCallbackUrl(cburl);
			
			ret = Card19Charge.getTransactionId(vo, cardnum1, cardnum2, version_id, merchant_id, order_date, currency);
		}
		else if (stype.equals("2"))
		{
			ret = Card19Charge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("19pay model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("19pay order id->(" + uid + ")" + ret);
