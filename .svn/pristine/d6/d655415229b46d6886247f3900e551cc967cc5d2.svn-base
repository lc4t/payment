...
public class LuMiServlet extends HttpServlet {
	...
	request.setCharacterEncoding("utf-8");
		...
		if (stype.equals("1")) {
			...
			System.out
					.println("lumi model invalid------------------------------------------------->"
							+ stype);
			ret = "invalid";
		}

		System.out.println("lumi order id->(" + uid + ")" + ret);
