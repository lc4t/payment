...
import noumena.payment.c921sdk.C921SDKCharge;
...
import noumena.payment.innova.InnovaCharge;
...
public class SingaporeContextListenerServlet
  implements ServletContextListener
{
  ...
  public void contextInitialized(ServletContextEvent arg0)
  {
    ...
    String propfile = path + application.getInitParameter("log4jConfigLocation");
