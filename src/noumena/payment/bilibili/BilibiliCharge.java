...
public class BilibiliCharge {
	private static BilibiliParams params = new BilibiliParams();
	...
	public static void setTestmode(boolean testmode) {
		BilibiliCharge.testmode = testmode;
	}
	...
	public static String getTransactionId(Orders order) {
		...
		if (cburl == null || cburl.equals("")) {
			...
			if (cburl.indexOf("?") == -1) {
				cburl += "?pt=" + Constants.PAY_TYPE_BILIBILI;
			} else {
				cburl += "&pt=" + Constants.PAY_TYPE_BILIBILI;
			}
	...
	public static String getCallbackFromBilibili(String data) {
		BilibiliOrderVO vo = null;
		System.out.println("bilibili cb ->" + data);
		JSONObject json = JSONObject.fromObject(data);
		vo = (BilibiliOrderVO) JSONObject.toBean(json, BilibiliOrderVO.class);
			...
			try {
				...
				if (order != null) {
					if (order.getKStatus() != Constants.K_STSTUS_SUCCESS) {
						...
						System.out.println("bilibili order ("
		...
		System.out.println("bilibili cb ret->" + ret);

		String path = OSUtil.getRootPath() + "../../logs/bilibilicb/"
	...
	public static void init() {
		params.addApp("gongzhu", "16", "nm8fzdbr2zbpesaesx8fvnzhqaz9tqsn");
		params.addApp("gangtie", "147", "cb9d24e21a594dd49049e658eb8b0c8f");
	}
}
