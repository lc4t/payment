...
public class Base64 {
    ...
    // private static final String TAG = GOAPKGF.TAG;
    ...
    /**
     * Decode the string and convert back the decoded value into a string using the specified charset. Use default
     * encoding if charset is null or invalid.
     */
    ...
    /**
     * Discards any characters outside of the base64 alphabet (see page 25 of RFC 2045) "Any characters outside of the
