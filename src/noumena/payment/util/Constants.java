...
public class Constants {
	...
	//尚米 小七
	public static final String PAY_TYPE_ShangMi = "6064";
	//777hwan
	...
	//爱应用
	public static final String PAY_TYPE_AIYINGYONG= "6076";
	public static final String PAY_TYPE_NicePlay = "6074";
	
	
	public static final String PAY_TYPE_IAPPAY= "6077";
	//lumi
	public static final String PAY_TYPE_LUMI = "00ss";
	
	public static final String PAY_TYPE_TUTU= "1234";
	// 沙箱测试
