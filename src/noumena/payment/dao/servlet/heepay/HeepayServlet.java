package noumena.payment.dao.servlet.heepay;
...
public class HeepayServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_HEEPAY);
			vo.setCallbackUrl(cburl);
			vo.setExInfo(goods_name);
			
			ret = HeepayCharge.getTransactionId(vo, pay_type, return_url, user_ip, agent_id);
		}
		else if (stype.equals("2"))
		{
			ret = HeepayCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(heepay model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(heepay order id)->(" + uid + ")" + ret);
