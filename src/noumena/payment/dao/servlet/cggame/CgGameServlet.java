package noumena.payment.dao.servlet.cggame;
...
public class CgGameServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		{
			System.out.println("CgGameServlet model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("CgGameServlet order id->(" + uid + ")" + ret);
