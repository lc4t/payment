...
public class I4Servlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_I4);
			vo.setCallbackUrl(cburl);
			
			ret = I4Charge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = I4Charge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("i4 model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("i4 order id->(" + uid + ")" + ret);
