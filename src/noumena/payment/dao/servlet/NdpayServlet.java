...
public class NdpayServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		vo.setExInfo(appid);
		vo.setPayType(Constants.PAY_TYPE_NDPAY);
		...
		if (stype.equals("1"))
		{
			ret = NdpayCharge.getTransactionId(vo);
		}
		else if (stype.equals("verify"))
		{
			String ndpayid = request.getParameter("uid");
			String sessionid = request.getParameter("sid");
			ret = ChannelVerify.verify("ndpay", ndpayid, "107577", sessionid, "", true);
		}
		else if (stype.equals("2"))
		{
			System.out.println("91 check order ids->" + payIds);
			ret = NdpayCharge.checkOrdersStatus(payIds);
		}
		else
		{
		...
		System.out.println("91 order id->" + ret);
