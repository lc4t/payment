package noumena.payment.dao.servlet.toutiao;
...
public class ToutiaoServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_TOUTIAO);
			vo.setCallbackUrl(cburl);
			
			ret = ToutiaoCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = ToutiaoCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(toutiao model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(toutiao order id)->(" + uid + ")" + ret);
