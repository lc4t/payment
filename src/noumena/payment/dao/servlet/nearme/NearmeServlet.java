...
public class NearmeServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String partnerid = request.getParameter("partnerid");	//开发者id
		String notifyurl = request.getParameter("notifyurl");	//回调链接
		...
		if (stype.equals("1"))
		{
			...
			vo.setSign(desc);
			vo.setPayType(Constants.PAY_TYPE_NEARME);
			vo.setCallbackUrl(cburl);
			
			ret = NearmeCharge.getTransactionId(vo, partnerid, notifyurl, name, payprice);
		}
		else if (stype.equals("2"))
		{
			ret = NearmeCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("oppo model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("oppo order id->(" + uid + ")" + ret);
