package noumena.payment.dao.servlet.bilibili;
...
public class BilibiliServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			if(!"com.kongzhong.noumena.android.d1cn.bilibili".equals(pkgid)){
				...
				vo.setPayType(Constants.PAY_TYPE_BILIBILI);
				vo.setCallbackUrl(cburl);
				
				ret = BilibiliCharge.getTransactionId(vo);
			}
		}
		else if (stype.equals("2"))
		{
			ret = BilibiliCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("bilibili model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("bilibili order id->(" + uid + ")" + ret);
