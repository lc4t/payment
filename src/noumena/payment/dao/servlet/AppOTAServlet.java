...
public class AppOTAServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setSign(appid);
			vo.setExInfo(chargetype);
			vo.setPayType(Constants.PAY_TYPE_APPOTA);
			vo.setCallbackUrl(cburl);
			
			ret = AppOTACharge.getTransactionId(vo);
		}
		else
		{
			ret = AppOTACharge.checkOrdersStatus(payIds);
		}

		System.out.println("appota order id->(" + uid + ")" + ret);
