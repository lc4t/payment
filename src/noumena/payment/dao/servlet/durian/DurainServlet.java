package noumena.payment.dao.servlet.durian;
 ...
 *
 */
public class DurainServlet extends HttpServlet {
	...
	request.setCharacterEncoding("utf-8");
		...
		if (stype.equals("1")) {
			...
			System.out
					.println("DurainServlet model invalid------------------------------------------------->"
							+ stype);
			ret = "invalid";
		}

		System.out.println("DurainServlet order id->(" + uid + ")" + ret);
