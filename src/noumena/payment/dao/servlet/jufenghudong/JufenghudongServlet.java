package noumena.payment.dao.servlet.jufenghudong;
...
public class JufenghudongServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_JUFENGHUDONG);
			vo.setCallbackUrl(cburl);
			vo.setSign(appid);
			
			ret = JufenghudongCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = JufenghudongCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("jufenghudong model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("jufenghudong order id->(" + uid + ")" + ret);
