package noumena.payment.dao.servlet.xiaoqi;
...
public class XiaoQiServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_C185sy);
			vo.setCallbackUrl(cburl);
			vo.setCurrency(Constants.CURRENCY_RMB);
			vo.setUnit(Constants.CURRENCY_UNIT_FEN);
			
			ret = OrderUtil.getTransactionId(vo, Constants.PAY_TYPE_ShangMi, "");
		}
		...
		{
			System.out.println("XiaoQi model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("XiaoQi order id->(" + uid + ")" + ret);
