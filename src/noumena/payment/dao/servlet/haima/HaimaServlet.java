package noumena.payment.dao.servlet.haima;
...
public class HaimaServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_HAIMA);
			vo.setCallbackUrl(cburl);
			
			ret = HaimaCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = HaimaCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(haima model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(haima order id)->(" + uid + ")" + ret);
