package noumena.payment.dao.servlet.youwan;
...
public class YouwanServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_YOUWAN);
			vo.setCallbackUrl(cburl);
			
			ret = YouwanCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = YouwanCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(youwan model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(youwan order id)->(" + uid + ")" + ret);
