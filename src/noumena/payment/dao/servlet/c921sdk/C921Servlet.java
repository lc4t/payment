package noumena.payment.dao.servlet.c921sdk;
...
public class C921Servlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (stype.equals("1")) {
			...
			vo.setPayType(Constants.PAY_TYPE_C921);
			vo.setCallbackUrl(cburl);
			vo.setSign(appid);
			System.out
					.println("C921 Orders param==============================>"
							+ vo);
			ret = OrderUtil.getTransactionId(vo, Constants.PAY_TYPE_QIDIAN, "");
		} else if (stype.equals("2")) {
			OrderStatusVO st = new OrderStatusVO();
			ret = OrderUtil.checkOrdersStatus(payIds, st);
		} else {
			System.out
					.println("C921 model invalid-==============================>"
							+ stype);
			ret = "invalid";
		}

		System.out
				.println("C921 order id-====================================>("
						+ uid + ")" + ret);
