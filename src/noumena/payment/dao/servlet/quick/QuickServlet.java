package noumena.payment.dao.servlet.quick;
...
public class QuickServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		//支付方的参数
		//String appid = request.getParameter("appid");//渠道在quick服务器的 ID
		//验证订单用参数
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_QUICK);
			vo.setCallbackUrl(cburl);
			
			ret = QuickCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = QuickCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(quick model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(quick order id)->(" + uid + ")" + ret);
