package noumena.payment.dao.servlet.yingyonghui;
...
public class YingyonghuiServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_YINGYONGHUI);
			vo.setCallbackUrl(cburl);
			
			ret = YingyonghuiCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = YingyonghuiCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(yingyonghui model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(yingyonghui order id)->(" + uid + ")" + ret);
