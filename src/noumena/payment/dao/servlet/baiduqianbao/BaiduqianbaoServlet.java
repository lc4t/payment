package noumena.payment.dao.servlet.baiduqianbao;
...
public class BaiduqianbaoServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setSign(appid);
			vo.setPayType(Constants.PAY_TYPE_BAIDUQIANBAO);
			vo.setCallbackUrl(cburl);
			
			ret = BaiduqianbaoCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = BaiduqianbaoCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("baiduqianbao model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("baiduqianbao order id->(" + uid + ")" + ret);
