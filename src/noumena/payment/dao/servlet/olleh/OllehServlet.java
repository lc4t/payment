package noumena.payment.dao.servlet.olleh;
...
public class OllehServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_OLLEH);
			vo.setCallbackUrl(cburl);
			
			ret = OllehCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = OllehCharge.checkOrdersStatus(payIds);
		}
		else if (stype.equals("3"))
		{
			...
			ret = OllehCharge.getTransactionIdAndStatus(vo);
		}
		else
		{
			System.out.println("olleh model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("olleh order id->(" + uid + ")" + ret);
