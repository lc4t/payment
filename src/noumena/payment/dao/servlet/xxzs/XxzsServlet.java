package noumena.payment.dao.servlet.xxzs;
...
public class XxzsServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_XXZS);
			vo.setCallbackUrl(cburl);
			
			ret = XxzsCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = XxzsCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(xxzs model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(xxzs order id)->(" + uid + ")" + ret);
