package noumena.payment.dao.servlet.sharejoy;
...
public class SharejoyServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_SHAREJOY);
			vo.setCallbackUrl(cburl);
			
			ret = SharejoyCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = SharejoyCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("sharejoy model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("sharejoy order id->(" + uid + ")" + ret);
