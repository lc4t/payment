package noumena.payment.dao.servlet.kudong;
...
public class KudongServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_KUDONG);
			vo.setCallbackUrl(cburl);
			
			vo.setSign(appid);
			
			ret = KudongCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = KudongCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("kudong model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("kudong order id->(" + uid + ")" + ret);
