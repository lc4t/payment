package noumena.payment.dao.servlet.c777hwan;
...
public class C777hwanServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_C777hwansy);
			vo.setCallbackUrl(cburl);
			vo.setCurrency(Constants.CURRENCY_RMB);
			vo.setUnit(Constants.CURRENCY_UNIT_YUAN);
			
			ret = OrderUtil.getTransactionId(vo, Constants.PAY_TYPE_C777hwansy, "");
		}
		...
		{
			System.out.println("c777hwanServlet model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("c777hwanServlet order id->(" + uid + ")" + ret);
