package noumena.payment.dao.servlet.kuaifa;
...
public class KuaifaServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_KUAIFA);
			vo.setCallbackUrl(cburl);
			
			ret = KuaifaCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = KuaifaCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(kuaifa model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(kuaifa order id)->(" + uid + ")" + ret);
