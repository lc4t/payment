package noumena.payment.dao.servlet.NicePlayV3;
...
public class NicePlayServlet extends HttpServlet {
	...
	request.setCharacterEncoding("utf-8");
		...
		if (stype.equals("1")) {
			...
			vo.setPayType(Constants.PAY_TYPE_NicePlay);
			vo.setCallbackUrl(cburl);
			vo.setCurrency(Constants.CURRENCY_TWD);
			vo.setUnit(Constants.CURRENCY_UNIT_YUAN);
			ret = OrderUtil.getTransactionId(vo, Constants.PAY_TYPE_NicePlay, "");
			...
			System.out
					.println("NicePlayServlet model invalid------------------------------------------------->"
							+ stype);
			ret = "invalid";
		}

		System.out.println("NicePlayServlet order id->(" + uid + ")" + ret);
