...
public class CaishenServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_CAISHEN);
			vo.setCallbackUrl(cburl);
			
			ret = CaishenCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = CaishenCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("caishen model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("caishen order id->(" + uid + ")" + ret);
