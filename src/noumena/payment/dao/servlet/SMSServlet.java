...
public class SMSServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String payTypeId = request.getParameter("paytypeid");	//5044（增值兜底） 5051（手游业务） 5052（第三方SDK） 5057（增值业务） 5059（第三方支付）
		...
		{
			payTypeId = Constants.PAY_TYPE_SMS;
		}
		...
		if (stype.equals("1"))
		{
//			System.out.println("SMS app id->" + vo.getAppId());
//			System.out.println("SMS product id->" + vo.getProductId());
//			System.out.println("SMS sub id->" + vo.getSubId());
			
			ret = SMSCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = SMSCharge.checkOrdersStatus(payIds);
		}
		else
		{
		...
		System.out.println("SMS order id->" + ret);
