package noumena.payment.dao.servlet.douyu;
...
public class DouyuServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_DOUYU);
			vo.setCallbackUrl(cburl);
			vo.setExInfo(appid);
			
			ret = DouyuCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = DouyuCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(douyu model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(douyu order id)->(" + uid + ")" + ret);
