...
public class PPSServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_PPS);
			vo.setCallbackUrl(cburl);
			
			ret = PPSCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = PPSCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("pps model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("pps order id->(" + uid + ")" + ret);
