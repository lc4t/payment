package noumena.payment.dao.servlet.guopan;
...
public class GuoPanServlet extends HttpServlet {
	...
	request.setCharacterEncoding("utf-8");
		...
		if (stype.equals("1")) {
			...
			ret = OrderUtil.getTransactionId(vo, Constants.PAY_TYPE_XXZS, "");
			...
			System.out
					.println("GuoPan model invalid------------------------------------------------->"
							+ stype);
			ret = "invalid";
		}

		System.out.println("GuoPan order id->(" + uid + ")" + ret);
