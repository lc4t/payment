package noumena.payment.dao.servlet.baifubao;
...
public class BaifubaoServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_BAIFUBAO);
			vo.setCallbackUrl(cburl);
			vo.setSign(appid);
			
			ret = BaifubaoCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = BaifubaoCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("baifubao model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("baifubao order id->(" + uid + ")" + ret);
