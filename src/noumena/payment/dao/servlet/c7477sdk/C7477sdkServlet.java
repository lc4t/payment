package noumena.payment.dao.servlet.c7477sdk;
...
public class C7477sdkServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			ret = OrderUtil.getTransactionId(vo, Constants.PAY_TYPE_C185sy, "");
		}
		...
		{
			System.out.println("sougou model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("sougou order id->(" + uid + ")" + ret);
