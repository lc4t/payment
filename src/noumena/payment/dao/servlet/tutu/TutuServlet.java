package noumena.payment.dao.servlet.tutu;
...
public class TutuServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (stype.equals("1")) {
			...
			System.out.println("TutuServlet model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("TutuServlet order id->(" + uid + ")" + ret);
