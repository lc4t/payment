package noumena.payment.dao.servlet.kuaiyong;
...
public class KuaiyongServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_KUAIYONG);
			vo.setCallbackUrl(cburl);
			vo.setSign(appid);
			
			ret = KuaiyongCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = KuaiyongCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("kuaiyong model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("kuaiyong order id->(" + uid + ")" + ret);
