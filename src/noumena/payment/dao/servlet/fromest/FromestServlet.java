...
public class FromestServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_FROMEST);
			vo.setCallbackUrl(cburl);
			
			ret = FromestCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = FromestCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("fromest model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("fromest order id->(" + uid + ")" + ret);
