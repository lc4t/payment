package noumena.payment.dao.servlet.sougou;
...
public class SougouServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_SOUGOU);
			vo.setCallbackUrl(cburl);
			
			ret = SougouCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = SougouCharge.checkOrdersStatus(payIds);
		}
		else
		{
