package noumena.payment.dao.servlet.snail;
...
public class SnailServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_SNAIL);
			vo.setCallbackUrl(cburl);
			
			ret = SnailCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = SnailCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("snail model invalid->" + stype);
			ret = "invalid";
		}

		System.out.println("snail order id->(" + uid + ")" + ret);
