package noumena.payment.dao.servlet.anzhi;
...
public class AnzhiServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setSign(appid);
			vo.setPayType(Constants.PAY_TYPE_ANZHI);
			vo.setCallbackUrl(cburl);
			
			ret = AnzhiCharge.getTransactionId(vo);
		}
		else
		{
			ret = AnzhiCharge.checkOrdersStatus(payIds);
		}

		System.out.println("anzhi order id->(" + uid + ")" + ret);
