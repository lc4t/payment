...
public class xiaomiServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		{
			payTypeId = Constants.PAY_TYPE_XIAOMI;
		}
		...
		if (stype.equals("1"))
		{
			...
			ret = xiaomiCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			System.out.println("check order ids->" + payIds);
			ret = xiaomiCharge.checkOrdersStatus(payIds);
		}
		else
		{
