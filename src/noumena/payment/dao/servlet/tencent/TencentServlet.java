package noumena.payment.dao.servlet.tencent;
...
public class TencentServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		System.out.println("----styppppeeee:"+stype);
		String ret = "";
		if (stype == null)
		{
			stype = "";
		...
		if (stype.equals("1"))
		{
			...
			ret = TencentCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			...
			ordervo.setPay_token(pay_token);
			ordervo.setPf(pf);
			ordervo.setPfkey(pfkey);
			ordervo.setType(type);
			ordervo.setAppid(appid);
			
			ret = TencentCharge.checkOrdersStatus(payIds, ordervo);
		}
		else if (stype.equals("3")) 
		{
			...
			ret = TencentCharge.getTransactionIdAndStatus(vo, ordervo);
		}
		else
		{
