package noumena.payment.dao.servlet.c4399;
...
public class C4399Servlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_4399);
			vo.setCallbackUrl(cburl);
			vo.setExInfo(appid);
			
			ret = C4399Charge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = C4399Charge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(4399 model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(4399 order id)->(" + uid + ")" + ret);
