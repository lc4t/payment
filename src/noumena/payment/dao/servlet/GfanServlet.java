...
public class GfanServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		//支付方的参数
		String appid = request.getParameter("appid");			//gfan分配的游戏的appid
		...
		if (stype.equals("1"))
		{
			...
			vo.setSign(appid);
			vo.setPayType(Constants.PAY_TYPE_GFAN);
			vo.setCallbackUrl(cburl);
			
			ret = GfanCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = GfanCharge.checkOrdersStatus(payIds);
		}
		else
		{
		...
		System.out.println("gfan order id->" + ret);
