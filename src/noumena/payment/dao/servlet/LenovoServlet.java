...
public class LenovoServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (stype.equals("1"))
		{
			...
			vo.setExInfo("");
			vo.setPayType(Constants.PAY_TYPE_LENOVO);
			vo.setCallbackUrl(cburl);
			
			ret = LenovoCharge.getTransactionId(vo);
		}
		else
		{
			ret = LenovoCharge.checkOrdersStatus(payIds);
		}

		System.out.println("lenovo order id->(" + uid + ")" + ret);
