package noumena.payment.dao.servlet.c37wan;
...
public class C37wanServlet extends HttpServlet
{
...
request.setCharacterEncoding("utf-8");
		...
		if (stype.equals("1"))
		{
			...
			vo.setPayType(Constants.PAY_TYPE_37WAN);
			vo.setCallbackUrl(cburl);
			vo.setExInfo(product_subject);
			vo.setSign(appid);
			vo.setItemNum(Integer.parseInt(buy_amount));
			
			ret = C37wanCharge.getTransactionId(vo);
		}
		else if (stype.equals("2"))
		{
			ret = C37wanCharge.checkOrdersStatus(payIds);
		}
		else
		{
			System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(C37wan model invalid)->" + stype);
			ret = "invalid";
		}

		System.out.println("=====(" + DateUtil.getCurTimeStr() + ")=====channel(C37wan order id)->(" + uid + ")" + ret);
